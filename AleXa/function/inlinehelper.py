...
from AleXa import BOT_USERNAME, OWNER_ID
from AleXa.config import get_str_key
from AleXa.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from AleXa.function.pluginhelpers import fetch
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
