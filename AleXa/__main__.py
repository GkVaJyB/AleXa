...
from AleXa.modules.sql.users_sql import add_chat_to_db
...
buttons = [
    [
        InlineKeyboardButton(
            text="AleXa News 🙋‍♂️", url="https://t.me/AleXa_Updates"
        ),
        InlineKeyboardButton(
            text="Developer", url="https://t.me/Asanga_Udara"
        ),
       
    ],
    [
        InlineKeyboardButton(
            text="Command Help ❓", url="http://t.me/TheAleXaBot?start=help"
        ),
    ],
   
]

AleXa_IMG = "https://telegra.ph/file/b3c58ee878c4e1216e4fe.jpg"

HELP_STRINGS = f"""
*ALL Commands :* [❤]()

✨ Every possibility of AleXa is documentated here.
...
def AleXa_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by AleXa Updates.* "
            f"\n\n Join [AleXaUpdates](https://t.me/AleXa_Updates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [AleXa Support](https://t.me/AleXaSupport_Official).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by AleXa Updates team spending many sleepless nights.. So, Respect it."
            f"\n✪ Some modules in this bot is owned by different authors, So, \n  All credits goes to them \n  Also for <b>Paul Larson for Marie</b>."
            f"\n✪ If you need to ask anything about \n  this bot, Go @{SUPPORT_CHAT}."
            f"\n✪ If you asking nonsense in Support \n  Chat, you will get warned/banned."
            f"\n✪ All api's we used owned by originnal authors \n  Some api's we use Free version \n  Please don't overuse AI Chat."
            f"\n✪ We don't Provide any support to forks,\n  So these terms and conditions not applied to forks \n  If you are using a fork of TheAleXaBot we are not resposible for anything."
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        AleXa_about_callback, pattern=r"aboutmanu_"
    )
