...
if ENV:
    ...
    DURATION_LIMIT = os.environ.get("DURATION_LIMIT")
    ...
    from AleXa.config import Development as Config
...
pbot = Client("AleXa", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
